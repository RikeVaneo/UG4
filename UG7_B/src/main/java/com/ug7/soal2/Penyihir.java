...
public class Penyihir extends Karakter{
    ...
    public void abilityAttack(Karakter karakter) {
        ...
        if(this.isAbilityReady){
            ...
            System.out.println(karakter.getPlayer().getUsername() +
                    " terkena serangan! Sisa HP "
                    + karakter.getPlayer().getUsername() + ": " + karakter.getHP());
            if (this.getHP() <= 0){
    ...
    public void normalAttack(Karakter karakter) {
        if (this.getWeapon() != 0) {
            if (super.isWalk()) {
                ...
                System.out.println(karakter.getPlayer().getUsername()
                        + " terkena serangan! Sisa HP " + karakter.getPlayer().getUsername() + ": " + karakter.getHP());
                if (karakter.getHP() <= 0) {
            ...
            System.out.println("Maaf, " + this.getPlayer().getUsername()
